...
void menuProducer(ListParent &L) {
    ...
    while (choice != 0) {
        ...
        cout << "==========================================" << endl;
        cout << "1. [CREATE] Registrasi Film Baru" << endl;
        cout << "2. [DELETE] Hapus Film Tertentu (ID)" << endl;
        cout << "3. [DELETE] Bersihkan Film Flop (Auto Rating < 5)" << endl;
        cout << "4. [INSERT] Casting Aktor Baru" << endl;
        cout << "5. [DELETE] Pecat Aktor Tertentu (ID)" << endl;
        cout << "6. [DELETE] Hapus Semua Cameo (Efisiensi)" << endl;
        cout << "7. [VIEW]   Lihat Database Lengkap" << endl;
...
void menuAuditor(ListParent &L) {
    ...
    while (choice != 0) {
        ...
        cout << "==========================================" << endl;
        cout << "1. [SEARCH]  Cari Data Film" << endl;
        cout << "2. [SEARCH]  Validasi Aktor di Film" << endl;
        cout << "3. [COMPUTE] Laporan Beban Gaji Film" << endl;
...
int main() {
    ...
    while (mainChoice != 0) {
        ...
        cout << "##########################################" << endl;
        cout << "1. Masuk sebagai PRODUCER (Admin)" << endl;
        cout << "2. Masuk sebagai AUDITOR (Analyst)" << endl;
        cout << "0. Keluar" << endl;
        cout << ">> Pilih Role: "; 
        cin >> mainChoice;
